...
public class ResultMessage  implements java.io.Serializable {
    ...
    /**
     * Gets the errorMessage value for this ResultMessage.
     * 
     * @return errorMessage
     */
    ...
    /**
     * Sets the errorMessage value for this ResultMessage.
     * 
     * @param errorMessage
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://cxf.plminterface.mes.taharaiot.com/", "resultMessage"));
