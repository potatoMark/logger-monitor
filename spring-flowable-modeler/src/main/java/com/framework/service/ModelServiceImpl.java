...
import com.framework.configration.domain.*;
import com.framework.configration.exception.BadRequestException;
...
import com.framework.model.ModelKeyRepresentation;
import com.framework.model.ModelRepresentation;
import com.framework.model.ReviveModelResultRepresentation;
import com.framework.model.decisiontable.DecisionTableDefinitionRepresentation;
import com.framework.repository.ModelHistoryRepository;
import com.framework.repository.ModelRelationRepository;
import com.framework.repository.ModelRepository;
import com.framework.repository.ModelSort;
...
public class ModelServiceImpl implements ModelService {
    ...
    public List<Model> getReferencedModels(String modelId) {
        return modelRepository.findByParentModelId(modelId);
    }
        ...
        if (fileName != null && (fileName.endsWith(".bpmn") || fileName.endsWith(".bpmn20.xml"))) {
            try {
                ...
                AbstractModel savedModel = saveModel(modelId, processModel.getName(), processModel.getKey(),
                        processModel.getDescription(), modelNode.toString(), true, "Version import via REST service", null);
